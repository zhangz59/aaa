...
class IxiDataset(Dataset):
    ...
    def __init__(self, csv_path,
                 base_path='D:/OneDrive - Lancaster University/博士项目/脑年龄预测项目/MedicalBagNet-master(new)/IXI/',
                 scale='2mm', attribute='sex',
                 augment=False):
    ...
    def __getitem__(self, index):
        ...
        print(t1p)
        t1 = sitk.GetArrayFromImage(sitk.ReadImage(t1p))
